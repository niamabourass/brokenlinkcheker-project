            ...
            <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-4 mb-6">
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-5">
                        <p class="text-sm text-gray-500">Total des scans</p>
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-5">
                        <p class="text-sm text-gray-500">Liens indexés</p>
                        <h3 class="mt-2 text-2xl font-bold">
                            {{ $totalIndexedLinks }}
                        </h3>
                    </div>
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-5">
                        <p class="text-sm text-gray-500">Liens cassés</p>
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-5">
                        <p class="text-sm text-gray-500">Dernier scan</p>
                        <h3 class="mt-2 text-sm font-semibold truncate">
                            {{ $lastScan ? $lastScan->host : 'Aucun scan' }}
                        </h3>
                    </div>
                ...
                <div class="rounded-2xl border border-red-200 bg-white p-6">
                    ...
                    <p class="mb-4 text-gray-500">
                        Ces actions sont sensibles et doivent être utilisées avec précaution.
                    </p>
