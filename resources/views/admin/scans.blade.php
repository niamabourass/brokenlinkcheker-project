  ...
  >
    ...
    <li>
        <a href="{{ url('/') }}"
           ...
           class="group flex items-center justify-between rounded-2xl border border-gray-200 bg-slate-100 px-4 py-4 shadow-sm hover:bg-white hover:shadow-md transition-all duration-300">
                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr class="border-b">
                                ...
                                <th class="px-4 py-3 text-left">Indexés</th>
                                <th class="px-4 py-3 text-left">Cassés</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-3">
                                    <span class="rounded-full bg-blue-100 px-2 py-1 text-blue-600">
                                        {{ $scan->indexed }}
                                    </span>
                                </td>
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    @else
                                        <span class="rounded-full bg-green-100 px-2 py-1 text-green-600">
                                            0
                                        </span>
                                    @endif
                                </td>
                                ...
                                <td class="px-4 py-3">
                                    <a
                                        href="{{ url('/admin/scan/'.$scan->id) }}"
                                        style="background:#2563eb;color:white;padding:8px 16px;border-radius:8px;display:inline-block;font-weight:600;">
                                        Voir détails
                                    </a>
                                </td>
                            </tr>
