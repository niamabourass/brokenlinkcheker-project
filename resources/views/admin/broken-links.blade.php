                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr class="border-b">
                                ...
                                <th class="px-4 py-3 text-left">Liens cassés</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    <a href="{{ url('/admin/scan/'.$scan->id) }}"  class="inline-flex items-center rounded-lg bg-brand-500 px-4 py-2 text-sm font-medium text-white hover:bg-brand-600">
                                        Voir les liens
                                    </a>
