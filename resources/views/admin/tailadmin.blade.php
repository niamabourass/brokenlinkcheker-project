...
<html lang="en">
  ...
  <link rel="icon" href="{{ asset('admin_old/favicon.ico') }}">
<link href="{{ asset('admin_old/style.css') }}" rel="stylesheet">
  ...
  >
    <a href="index.html">
      <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
        <img class="dark:hidden" src="{{ asset('admin_old/src/images/logo/logo.svg') }}" alt="Logo" />
        <img class="hidden dark:block" src="{{ asset('admin_old/src/images/logo/logo-dark.svg') }}" alt="Logo" />
      </span>

      <img
        class="logo-icon"
        :class="sidebarToggle ? 'lg:block' : 'hidden'"
        src="{{ asset('admin_old/src/images/logo/logo-icon.svg') }}"
        alt="Logo"
      />
    </a>
  </div>
...
<h3 class="mt-3 text-3xl font-bold text-gray-800 dark:text-white">
120
</h3>
...
<h3 class="mt-3 text-3xl font-bold text-error-600">
342
</h3>
...
<!-- End Broken Link Checker Metrics -->
  <!-- Metric Item End -->
</div>
<!-- Metric Group One -->
...
<!-- ====== Table One End -->
  ...
  <script src="{{ asset('admin_old/bundle.js') }}"></script></body>
</html>
